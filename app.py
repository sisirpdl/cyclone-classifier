...
def dashboard():
    ...
    weatherdict = requests.get(f'http://api.openweathermap.org/data/2.5/weather?q={city}&appid=02b5ad2898ca71d51c4a7c03a4381186').json()
    return render_template('dashboard.html', weather = weatherdict, city = city, country = country)
